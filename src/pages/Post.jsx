        ...
        <>
            <PostContainer className="container">
                ...
                <div className="text-box">
                    ...
                    <p className="text">
                        ...
                        <br />· 슬개골 탈구 2기<br />
                        슬개골에 힘을 가해 탈구시켰을 때, 다시 제자리로 돌아가지 않거나, ‘딱’ 소리를 내며 돌아갑니다.<br />
                        강아지가 아파하거나, 앉았다 일어날 때 힘들어할 수 있습니다.<br />
                        또한, 관절이 붓거나 열감이 나타나는 등 관절염 증상이 나타나는 시기이기도 합니다.<br />
                        하지만 부종이나 열감이 없어도 통증이 있거나 강아지가 걷기 힘들어 보인다면
                        관절에 염증이 생겼다는 말이니 바로 진찰을 받아야 합니다.<br />
            ...
            <RandomPostContainer className="container">
                <div className="random-post-wrapper">
                    ...
                    <div className="random-post-box">
                        <Link to='/health/post' className="random-post">
